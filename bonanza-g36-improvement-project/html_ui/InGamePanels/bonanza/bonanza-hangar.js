...
checkAutoload();
  ...
  function resetCylinder1() {
    var iframe = document.getElementById('iframeId');
    var innerDoc = iframe.contentDocument || iframe.contentWindow.document;
    var seed = SimVar.GetSimVarValue("L:G36XIP_RANDOMSEED", "number");
    randomnumber = middleSquareMethod(seed)/1000.0;
  ...
  function middleSquareMethod(seed) {
      ...
      SimVar.SetSimVarValue("L:G36XIP_RANDOMSEED", "number", seed);
  ...
  function htmlHome() {
    ...
    console.log(GetStoredData('G36XIP_HOBBS_'+this.livery));
  ...
  function htmlState() {
    ...
    setInterval(updatePanelState, 10000);
    ...
    function updatePanelState() {
      ...
      if (innerDoc.getElementById("panelState")) {
        var title = SimVar.GetSimVarValue("TITLE", "string");
        this.livery = title.replace(/\s+/g, '_');
      ...
      else if (innerDoc.getElementById("panelMaintenance")) {
        var title = SimVar.GetSimVarValue("TITLE", "string");
        this.livery = title.replace(/\s+/g, '_');
